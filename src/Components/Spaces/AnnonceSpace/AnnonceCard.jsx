...
function AnnonceCard({ key="" , Category , Type , Surface , Desc , Price , Image , grid=false  }) {
    return (

        <div className="card w-full relative  rounded-3xl rounded-tr-none  bg-base-100 shadow-xl md:hover:scale-[102%] transition duration-300 ease-out ">
        <figure className='w-full h-full'><img src="https://placeimg.com/400/225/arch" alt="Shoes" className='w-full h-full' /></figure>
        <div className="card-body">
            ...
            <div className='absolute bg-night p-3 text-white right-0 rounded-bl-xl text-xl w-1/2 text-center font-bold'>19 000 00 DA</div>
